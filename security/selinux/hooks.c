				       ...
				       void **value, size_t *len)
{
	...
	if (!selinux_state.initialized || !(sbsec->flags & SBLABEL_MNT)) // SEC_SELINUX_PORTING_COMMON Change to use RKP
		return -EOPNOTSUPP;
...
{
	if (state->initialized) {     // SEC_SELINUX_PORTING_COMMON Change to use RKP
